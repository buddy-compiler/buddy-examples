...
float32_param_text_encoder.tofile(os.path.join(output_dir, "arg0_text_encoder.data"))

int64_param_text_encoder = params_text_encoder[-1].detach().cpu().numpy().reshape([-1])
int64_param_text_encoder.tofile(os.path.join(output_dir, "arg1_text_encoder.data"))
