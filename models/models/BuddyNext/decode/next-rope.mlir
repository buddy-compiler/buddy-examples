...
func.func @kernel(%arg0 : tensor<1x40x4096xf32>, %arg1 : tensor<1x40x4096xf32>, %arg2 : tensor<1x40x4096xf32>, %arg3 : tensor<1x1x2048x128xf32>, %arg4 : tensor<1x1x2048x128xf32>, %arg5 : tensor<1x40xi64>) {
  ...
  %79 = tosa.reshape %78, %s1 : (tensor<1x40x128xf32>, !tosa.shape<4>) -> tensor<1x1x40x128xf32>
  %80 = tosa.mul %59, %76, %shift : (tensor<1x32x40x128xf32>, tensor<1x1x40x128xf32>, tensor<1xi8>) -> tensor<1x32x40x128xf32>
  ...
  %81 = tosa.negate %extracted_slice_16, %zero, %zero : (tensor<1x32x40x64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x32x40x64xf32>
  ...
  %83 = tosa.mul %inserted_slice_17, %79, %shift : (tensor<1x32x40x128xf32>, tensor<1x1x40x128xf32>, tensor<1xi8>) -> tensor<1x32x40x128xf32>
  %84 = tosa.add %80, %83 : (tensor<1x32x40x128xf32>, tensor<1x32x40x128xf32>) -> tensor<1x32x40x128xf32>
  %85 = tosa.mul %62, %76,  %shift : (tensor<1x32x40x128xf32>, tensor<1x1x40x128xf32>, tensor<1xi8>) -> tensor<1x32x40x128xf32>
  ...
  %86 = tosa.negate %extracted_slice_19, %zero, %zero : (tensor<1x32x40x64xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x32x40x64xf32>
