...
func.func @kernel(%arg0: tensor<1x1024x1536xf32>, %arg1: tensor<1536xf32>, %arg2 : tensor<256xf32>, %arg3: tensor<1536x1536xf32>, %arg4: tensor<256x1536xf32>, %arg5: tensor<1x1024x128xf32>) -> (tensor<1x12x1024x128xf32>, tensor<1x12x1024x128xf32>, tensor<1x12x1024x128xf32>) {
  ...
  %67 = tosa.reshape %arg0, %s0 : (tensor<1x1024x1536xf32>, !tosa.shape<2>) -> tensor<1024x1536xf32>
  %69 = tosa.transpose %arg3 {perms = array<i32: 1, 0>} : (tensor<1536x1536xf32>) -> tensor<1536x1536xf32>
  %s1 = tosa.const_shape {values = dense<[1, 1024, 1536]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %70 = tosa.reshape %67, %s1 : (tensor<1024x1536xf32>, !tosa.shape<3>) -> tensor<1x1024x1536xf32>
  %s2 = tosa.const_shape {values = dense<[1, 1536, 1536]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %71 = tosa.reshape %69, %s2 : (tensor<1536x1536xf32>, !tosa.shape<3>) -> tensor<1x1536x1536xf32>
  %72 = tosa.matmul %70, %71, %a_zp, %b_zp : (tensor<1x1024x1536xf32>, tensor<1x1536x1536xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x1024x1536xf32>
  %73 = tosa.reshape %72, %s0 : (tensor<1x1024x1536xf32>, !tosa.shape<2>) -> tensor<1024x1536xf32>
  %s3 = tosa.const_shape {values = dense<[1, 1536]> : tensor<2xindex>} : () -> !tosa.shape<2>
  %74 = tosa.reshape %arg1, %s3 : (tensor<1536xf32>, !tosa.shape<2>) -> tensor<1x1536xf32>
  %75 = tosa.add %74, %73 : (tensor<1x1536xf32>, tensor<1024x1536xf32>) -> tensor<1024x1536xf32>
  %76 = tosa.reshape %75, %s1 : (tensor<1024x1536xf32>, !tosa.shape<3>) -> tensor<1x1024x1536xf32>
  %77 = tosa.reshape %arg0, %s0 : (tensor<1x1024x1536xf32>, !tosa.shape<2>) -> tensor<1024x1536xf32>
  %79 = tosa.transpose %arg4 {perms = array<i32: 1, 0>} : (tensor<256x1536xf32>) -> tensor<1536x256xf32>
  %80 = tosa.reshape %77, %s1 : (tensor<1024x1536xf32>, !tosa.shape<3>) -> tensor<1x1024x1536xf32>
  %s4 = tosa.const_shape {values = dense<[1, 1536, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %81 = tosa.reshape %79, %s4 : (tensor<1536x256xf32>, !tosa.shape<3>) -> tensor<1x1536x256xf32>
  %82 = tosa.matmul %80, %81, %a_zp, %b_zp : (tensor<1x1024x1536xf32>, tensor<1x1536x256xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x1024x256xf32>
  %s5 = tosa.const_shape {values = dense<[1024, 256]> : tensor<2xindex>} : () -> !tosa.shape<2>
  %83 = tosa.reshape %82, %s5 : (tensor<1x1024x256xf32>, !tosa.shape<2>) -> tensor<1024x256xf32>
  %s6 = tosa.const_shape {values = dense<[1, 256]> : tensor<2xindex>} : () -> !tosa.shape<2>
  %84 = tosa.reshape %arg2, %s6 : (tensor<256xf32>, !tosa.shape<2>) -> tensor<1x256xf32>
  %85 = tosa.add %84, %83 : (tensor<1x256xf32>, tensor<1024x256xf32>) -> tensor<1024x256xf32>
  %s7 = tosa.const_shape {values = dense<[1, 1024, 256]> : tensor<3xindex>} : () -> !tosa.shape<3>
  %86 = tosa.reshape %85, %s7 : (tensor<1024x256xf32>, !tosa.shape<3>) -> tensor<1x1024x256xf32>
  %87 = tosa.reshape %arg0, %s0 : (tensor<1x1024x1536xf32>, !tosa.shape<2>) -> tensor<1024x1536xf32>
  %89 = tosa.transpose %arg4 {perms = array<i32: 1, 0>} : (tensor<256x1536xf32>) -> tensor<1536x256xf32>
  %90 = tosa.reshape %87, %s1 : (tensor<1024x1536xf32>, !tosa.shape<3>) -> tensor<1x1024x1536xf32>
  %91 = tosa.reshape %89, %s4 : (tensor<1536x256xf32>, !tosa.shape<3>) -> tensor<1x1536x256xf32>
  %92 = tosa.matmul %90, %91, %a_zp, %b_zp : (tensor<1x1024x1536xf32>, tensor<1x1536x256xf32>, tensor<1xf32>, tensor<1xf32>) -> tensor<1x1024x256xf32>
  %93 = tosa.reshape %92, %s5 : (tensor<1x1024x256xf32>, !tosa.shape<2>) -> tensor<1024x256xf32>
  %94 = tosa.reshape %arg2, %s6 : (tensor<256xf32>, !tosa.shape<2>) -> tensor<1x256xf32>
  %95 = tosa.add %94, %93 : (tensor<1x256xf32>, tensor<1024x256xf32>) -> tensor<1024x256xf32>
  %96 = tosa.reshape %95, %s7 : (tensor<1024x256xf32>, !tosa.shape<3>) -> tensor<1x1024x256xf32>
  %s8 = tosa.const_shape {values = dense<[1, 1024, 12, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %97 = tosa.reshape %76, %s8 : (tensor<1x1024x1536xf32>, !tosa.shape<4>) -> tensor<1x1024x12x128xf32>
  %99 = tosa.transpose %97 {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x1024x12x128xf32>) -> tensor<1x12x1024x128xf32>
  %s9 = tosa.const_shape {values = dense<[1, 1024, 2, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %100 = tosa.reshape %86, %s9 : (tensor<1x1024x256xf32>, !tosa.shape<4>) -> tensor<1x1024x2x128xf32>
  %102 = tosa.transpose %100 {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x1024x2x128xf32>) -> tensor<1x2x1024x128xf32>
  %103 = tosa.reshape %96, %s9 : (tensor<1x1024x256xf32>, !tosa.shape<4>) -> tensor<1x1024x2x128xf32>
  %105 = tosa.transpose %103 {perms = array<i32: 0, 2, 1, 3>} : (tensor<1x1024x2x128xf32>) -> tensor<1x2x1024x128xf32>
  %s10 = tosa.const_shape {values = dense<[1, 1, 1024, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %106 = tosa.reshape %arg5, %s10 : (tensor<1x1024x128xf32>, !tosa.shape<4>) -> tensor<1x1x1024x128xf32>
  %107 = tosa.reshape %arg5, %s10 : (tensor<1x1024x128xf32>, !tosa.shape<4>) -> tensor<1x1x1024x128xf32>
  %108 = tosa.mul %99, %106, %shift : (tensor<1x12x1024x128xf32>, tensor<1x1x1024x128xf32>, tensor<1xi8>) -> tensor<1x12x1024x128xf32>
  ...
  %112 = tosa.mul %inserted_slice_30, %107, %shift : (tensor<1x12x1024x128xf32>, tensor<1x1x1024x128xf32>, tensor<1xi8>) -> tensor<1x12x1024x128xf32>
  %113 = tosa.add %108, %112 : (tensor<1x12x1024x128xf32>, tensor<1x12x1024x128xf32>) -> tensor<1x12x1024x128xf32>
  %114 = tosa.mul %102, %106, %shift : (tensor<1x2x1024x128xf32>, tensor<1x1x1024x128xf32>, tensor<1xi8>) -> tensor<1x2x1024x128xf32>
  ...
  %118 = tosa.mul %inserted_slice_34, %107, %shift : (tensor<1x2x1024x128xf32>, tensor<1x1x1024x128xf32>, tensor<1xi8>) -> tensor<1x2x1024x128xf32>
  ...
  %s11 = tosa.const_shape {values = dense<[1, 2, 1, 1024, 128]> : tensor<5xindex>} : () -> !tosa.shape<5>
  %120 = tosa.reshape %extracted_slice_36, %s11 : (tensor<1x2x1024x128xf32>, !tosa.shape<5>) -> tensor<1x2x1x1024x128xf32>
  ...
  %121 = "tosa.const"() <{values = dense<0.000000e+00> : tensor<1x2x6x1024x128xf32>}> : () -> tensor<1x2x6x1024x128xf32>
  ...
  %s12 = tosa.const_shape {values = dense<[1, 12, 1024, 128]> : tensor<4xindex>} : () -> !tosa.shape<4>
  %124 = tosa.reshape %123, %s12 : (tensor<1x2x6x1024x128xf32>, !tosa.shape<4>) -> tensor<1x12x1024x128xf32>
  ...
  %125 = tosa.reshape %extracted_slice_40, %s11 : (tensor<1x2x1024x128xf32>, !tosa.shape<5>) -> tensor<1x2x1x1024x128xf32>
  ...
  %126 = "tosa.const"() <{values = dense<0.000000e+00> : tensor<1x2x6x1024x128xf32>}> : () -> tensor<1x2x6x1024x128xf32>
  ...
  %129 = tosa.reshape %128, %s12 : (tensor<1x2x6x1024x128xf32>, !tosa.shape<4>) -> tensor<1x12x1024x128xf32>
